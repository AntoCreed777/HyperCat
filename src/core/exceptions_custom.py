...
class JuegoTerminadoError(GatoError):
    ...
    def __init__(self):
        super().__init__("El juego ya ha terminado. No se pueden hacer más movimientos.")
...
class SubGatoTerminadoError(GatoError):
    ...
    def __init__(self):
        super().__init__("El sub-gato ya ha terminado. No se pueden hacer más movimientos en él.")
...
class FueraDeRangoError(MovimientoInvalidoError):
    ...
    def __init__(self):
        super().__init__("La fila o columna especificada está fuera del rango permitido del tablero.")
